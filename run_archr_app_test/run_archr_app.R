...
## Have to make upper dimension less than default of 30 since we only have 18 columns...
#proj <- addIterativeLSI(ArchRProj = proj, useMatrix = "TileMatrix", name = "IterativeLSI", dimsToUse = 1:15)
#
